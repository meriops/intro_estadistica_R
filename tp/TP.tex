...
%\includeonlyframes{d45}
\includeonlylecture{day3}
...
% ==> does no work with the selected theme (?)%%}}}
...
%\frametitle{Numero de errores en un follete}
%\begin{itemize}
%   \item Crear el vector \emph{err1} = 2 3 0 3 1 0 0 1
%   \item Calculan la media, la mediana y la varianza de \emph{err1}
%   \item Entre la versi\'on 1 y la versi\'on 2, se corregio las errores de la primera pagina
%   \item Crear el vector \emph{err2} = 0 3 0 3 1 0 0 1 que toma al dia el conteo de errores en el folleto \alert{sin} tipear el vector completo
%\end{itemize}
%\end{frame}%%}}}
%
