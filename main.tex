...
% description
% this is an introduction to R and statistics 
% from a workshop given in 2010 at the Charles Darwin Foundation, Puerto Ayora, Galapagos, Ecuado
% this is the code for the "course" material
...
% ----- to choose font using fontspec + xelatex -----
%%  \usepackage{fontspec}
...
%%  \setmainfont{Universalis ADF Cd Std}
%%  \setmainfont{Universalis ADF Cd Std}
%%  %\setsansfont{Banksia}%%}}}
...
% ----- logo -----%%{{{
% \pgfdeclareimage[height=1.5cm]{le-logo}{fcd-logo.png}
% \logo{\pgfuseimage{le-logo}}
%\pgfdeclareimage[height=0.5cm]{logo}{tu-logo}
%\logo{\pgfuseimage{logo}}
%\logo{\includegraphics[height=0.5cm]{logo.png}}
% ==| handout:1> does no work with the selected theme (?)%%}}}
...
% ===== SUBSECTION 1.3: LICENCE =====%%%{{{
\subsection*{Licencia}

%%----- licence 1 [label=lic1] -----%%{{{
...
\begin{itemize}
   ...
   \item Para ver una copia de esta licencia, visite: \newline {\footnotesize\url{http://creativecommons.org/licenses/by-nc-sa/3.0/ec/}}
...
\begin{frame}[label=binom2]
   ...
   \vspace{-1.5cm}
         \begin{figure}
            \includegraphics<1| handout:0>[scale=0.75]{figs/LoiBinom-n1.png}
            \includegraphics<2| handout:1>[scale=0.75]{figs/LoiBinom-n3.png}
            \includegraphics<3| handout:0>[scale=0.75]{figs/LoiBinom-n5.png}
            \includegraphics<4| handout:0>[scale=0.75]{figs/LoiBinom-n30.png}
         \end{figure}
\end{frame}%%%}}}
...
\begin{frame}[label=poiss2]
   ...
   \vspace{-1cm}
         \begin{figure}
            \includegraphics[scale=0.55]{figs/LoiPoiss.png}
         \end{figure}
\end{frame}%
\note[itemize]{
...
\begin{frame}[label=normdist2]
   ...
   \visible<2-| handout:1>{\begin{figure}
      \includegraphics<1| handout:0>[scale=0.6]{figs/LoiNorm1.png}
      \includegraphics<2| handout:0>[scale=0.6]{figs/LoiNorm2.png}
      \includegraphics<3| handout:0>[scale=0.6]{figs/LoiNorm3.png}
      \includegraphics<4| handout:0>[scale=0.6]{figs/LoiNorm4.png}
      \includegraphics<5| handout:1>[scale=0.6]{figs/LoiNorm5.png}
   \end{figure}
   }
\end{frame}%
\note[itemize]{
...
\begin{frame}[label=stdnorm]
   ...
   \begin{columns}[c, totalwidth=10cm]
      \begin{column}[]{6cm}
         \begin{figure}
            \includegraphics<1| handout:0>[scale=0.65]{figs/LoiNorm7.png}
            \includegraphics<2| handout:1>[scale=0.65]{figs/LoiNorm8.png}
            \includegraphics<3| handout:2>[scale=0.65]{figs/LoiNorm9.png}
            \includegraphics<4| handout:3>[scale=0.65]{figs/LoiNorm10.png}
         \end{figure}
      \end{column}
      \begin{column}[]{3.5cm}
         \begin{itemize}
...
\begin{frame}[label=critdecis1]
   ...
   \begin{columns}[c, totalwidth=10cm]
      \begin{column}[]{5.5cm}
         \begin{figure}
            \includegraphics<1| handout:0>[scale=0.6]{figs/LoiNorm9.png}
